...
$stmt = $pdo->prepare('SELECT * FROM pets WHERE category="bird" ORDER BY date_added DESC LIMIT ?,?');
...
$total_products = $pdo->query('SELECT * FROM pets WHERE category="bird" ')->rowCount();
?>
...
<div class="row px-0 mx-0 align-items-center" >
        ...
        <div class="col-lg-5 mt-5 mt-lg-0 mx-0">
          ...
          <img src="asset/imgs/birdpage.jpg" class="hero__img w-100">
            <!--
...
<div class="products content-wrapper">
    ...
    <div class="products-wrapper">
        ...
        <a href="index.php?page=product&id=<?=$product['id']?>" class="product">
            ...
            <img src="asset/petimgs/bird/<?=$product['img']?>" width="200" height="200" alt="<?=$product['name']?>">
